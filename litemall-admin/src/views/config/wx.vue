    ...
    >
      <el-tabs tab-position="left">
        <el-tab-pane label="首页配置">
          ...
          <el-form-item label="品牌直供栏目品牌商显示数量" prop="litemall_wx_index_brand">
          ...
          <!--</el-form-item>-->
          <el-form-item label="附近门店显示数量" prop="litemall_wx_index_partner">
            <el-input v-model="dataForm.litemall_wx_index_partner" />
          </el-form-item>
        </el-tab-pane>
